...
outcomes2013 <- read.csv("filtered_2013.csv")
#head(outcomes2013)
```
...
ggplot(num_completed_by_gender)+title("# of graduates, male vs female")+ylab("fanny poops in her hand lol lol")
...
MARRIED <- c(ncf$MARRIED, mean(as.numeric(outcomes2013$MARRIED),na.rm=TRUE))
